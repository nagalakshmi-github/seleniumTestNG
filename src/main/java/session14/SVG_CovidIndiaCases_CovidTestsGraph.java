...
public class SVG_CovidIndiaCases_CovidTestsGraph {
	...
	public static void main(String[] args) throws InterruptedException, ParseException {
		...
		jse.executeScript("arguments[0].scrollIntoView(true);",
				driver.findElement(By.xpath("(//div[@jsmodel='Lfq59c'])[2]")));

		WebElement graphResult = driver.findElement(By.xpath("(//*[name()='svg' and @class='uch-psvg'])[2]"));
		...
		for(int i=0;i<=-2*getTopLeftX;i++) {
			...
			System.out.println(driver.findElement(By.cssSelector("div.dw0rcc.QV6Zsc tbody")).getText());
		}
	}
}
